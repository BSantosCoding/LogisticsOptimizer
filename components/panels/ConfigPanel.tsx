...
import { Copy, Plus, ShieldAlert, Trash2, Lock } from 'lucide-react';
        ...
        {canManageConfig ? (
          <div className="bg-slate-900/50 p-3 rounded border border-slate-700 mb-4">
            <div className="flex gap-2 mb-2 items-center">
              ...
              <button onClick={handleAddTemplate} className="bg-blue-600 hover:bg-blue-500 text-white px-2 rounded h-8 flex items-center justify-center"><Plus size={16} /></button>
            </div>
      ...
      <div className="p-4">
        ...
        {canManageConfig ? (
          <div className="flex gap-2 mb-3 items-center">
            ...
            />
            <button onClick={handleAddTag} className="bg-purple-600 hover:bg-purple-500 text-white px-3 py-2 rounded flex items-center gap-1">
              <Plus size={16} /> Add
            </button>
          </div>
        ) : (
